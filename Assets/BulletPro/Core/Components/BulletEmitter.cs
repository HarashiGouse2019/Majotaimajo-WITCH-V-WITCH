...
// Editted By: Miijii <kayaneseera@gmail.com>
...
namespace BulletPro
{
    ...
    public class BulletEmitter : MonoBehaviour
    {
        ...
        {
            if (!isInitialized ||
                (controlByLevel && PowerGradeSystem.CurrentLevel + 1 < enableAtPowerLevel) ||
                (controlByLevel && disableAboveLevel && PowerGradeSystem.CurrentLevel + 1 > enableAtPowerLevel + disableLevelOffset)) return;
