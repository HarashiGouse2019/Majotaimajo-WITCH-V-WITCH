...
public class DifficultySelection : MonoBehaviour, IEventSetup
{
    ...
    {
        _onSelectionPrevious = EventManager.AddNewEvent(090, "selectPrevious", difficultyMenu.OnClickHorizontalPrev);

        _onSelectionNext = EventManager.AddNewEvent(091, "selectNext", difficultyMenu.OnClickHorizontalNext);
